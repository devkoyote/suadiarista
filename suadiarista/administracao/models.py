...
class Servico(models.Model):
    ...
    ICONE_CHOISES = [
        ('tfw-cleaning-1','tfw-cleaning-1'),
        ('tfw-cleaning-2','tfw-cleaning-2'),
        ('tfw-cleaning-3','tfw-cleaning-3'),
    ]
    ...
    icone = models.CharField(null=False, blank=False, choices=ICONE_CHOISES, max_length=14)
